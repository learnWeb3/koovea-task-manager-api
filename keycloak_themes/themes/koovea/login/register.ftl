    ...
    <#elseif section="form">
        <form id="kc-register-form" action="${url.registrationAction}" method="post" class="w-full lg:w-2/3 flex flex-col gap-8 mt-16">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div>
                    <input tabindex="4" class="cursor-pointer h-12 bg-[#030635] hover:bg-black transition duration-150 ease-in-out rounded-full w-full text-white text-center" type="submit" value="Register" />
                </div>

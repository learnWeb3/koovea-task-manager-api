        ...
        <form  id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post" class="w-full lg:w-2/3 flex flex-col gap-8 mt-8">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div>
                ...
                <input tabindex="4" class="cursor-pointer h-12 bg-[#030635] hover:bg-black transition duration-150 ease-in-out rounded-full w-full text-white text-center" name="login" id="kc-login" type="submit" value="Login"/>
            </div>
